-- Repasse ao médico ajustado para 50/50 (decisão da proprietária, 2026-07-23).
-- Antes: plataforma retinha 20% (médico recebia 80%). Agora: 50% / 50%.
-- Vale para consultas concluídas a partir da aplicação desta migration.
